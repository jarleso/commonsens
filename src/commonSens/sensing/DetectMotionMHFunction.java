 ...
 * @author jarleso
 */
public class DetectMotionMHFunction implements CustomFunction {
    ...
    /**
     * Pulls the tuple sources in pullListToAdd. For DetectMotionMHFunction, it is
...
//                    tupleToSend = tmpTuple;
    ...
    public void setBelongingTupleSource(Sensor belTS) {
        ...
        this.belTS = belTS;
        this.capability = belTS.getProvidedCapability("DetectMotionMH");
